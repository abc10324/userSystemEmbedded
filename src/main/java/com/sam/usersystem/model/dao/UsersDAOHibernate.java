...
public class UsersDAOHibernate implements UsersDAO {
	...
	private final String SELECT_BY_ID = "from com.sam.usersystem.model.UsersBean a where lower(a.userID) = :userID";
	private final String SELECT_BY_NAME = "from com.sam.usersystem.model.UsersBean a where lower(a.userName) = :userName";
	private final String SELECT_LIKE_NAME = "select a.userName from com.sam.usersystem.model.UsersBean a where lower(a.userName) like :userName";
